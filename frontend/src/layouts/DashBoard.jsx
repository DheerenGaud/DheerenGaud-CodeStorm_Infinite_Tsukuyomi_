    ...
    return (
        <>
            ...
            <div className="flex font-poppins">
                <div className="flex h-screen flex-col justify-between border-e bg-white w-80">
                <div className="px-4 py-6">
                    <ul className="mt-6 space-y-1">
                        <li>
                            <Link className="block rounded-lg bg-gray-100 px-4 py-2 text-sm font-medium text-gray-700" to="/user">
                                General
                            </Link>
                        </li>
